...
const Navbar = () => {
    ...
    return (
        <div className="navbar-wrapper">
            <nav className="navbar bg-[#0E1317] text-white">
                ...
                <div className="navbar-end">
                    {user ? (
                        <div className="flex items-center space-x-4 relative">
                            ...
                            <button onClick={handleLogout} className="btn text-white rounded-sm bg-[#63AB45] border-none font-[400] text-xl hover:bg-white hover:text-black">Logout</button>
                        </div>
                    ) : (
                        <NavLink
                            to={'/login'}
                            className="btn text-white rounded-sm bg-[#63AB45] border-none w-[120px] font-[400] text-xl hover:bg-white hover:text-black"
